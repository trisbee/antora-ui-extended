= Hardware and Software Requirements haha
Author Name
:idprefix:
:idseparator: -
:!example-caption:
...
{
  "transactions" : [ {
    "id" : "a96c08ad-69bd-478c-af4a-346f731f9e34",
    "bankAccount" : "2901719070/2010",
    "dateOfTransaction" : "2021-01-05",
    "note" : "befeleme",
    "variableSymbol" : "28429201",
    "payerIdentification" : "TestPayment"
  } ]
}
----
